...
Evidence: a private project synced by hand twice in two days (the project's #11, #12). Each time an agent
...
Plus one real run: adopt, then sync, on a throwaway copy of a private project, with the plan and PR pasted in the PR.
